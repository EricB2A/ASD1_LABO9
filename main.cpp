...
public:
     ...
     *
     *  @remark Complexité O(N) avec N le nombre de sous arbres
     */
...
private:
    ...
    //@remark Complexite O(N) avec N nombre de noeuds dans src
...
private:
    ...
    //
    // @brief Recherche du noeud minimum d'un arbre
    //
    // @return Le noeud minimum du sous arre
    //
    // @exception std::logic_error si necessaire
    //
    // @remark O(Log(N)) avec N le nombre de noeuds dans l'arbre
...
public:
    ...
    //
    // @remark Complexité O(log(N)) avec N nombre de noeuds dans l'arbre
    //
